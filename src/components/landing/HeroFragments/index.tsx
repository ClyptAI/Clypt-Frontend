...
const fragments: FragmentDef[] = [
  ...
  { id: "clip-a",   Render: () => (
      <ClipChip title="The pivot moment that changes everything." range="0:34 - 1:00"
  ...
  { id: "clip-b",   Render: () => (
      <ClipChip title="That's the unlock right there." range="1:48 - 2:05"
  ...
  { id: "clip-c",   Render: () => (
      <ClipChip title="Wait, say that again." range="3:12 - 3:38"
