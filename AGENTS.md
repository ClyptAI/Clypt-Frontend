...
This project is indexed by GitNexus as **Clypt-Frontend** (1134 symbols, 2219 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
