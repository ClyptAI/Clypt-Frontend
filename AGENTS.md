...
This project is indexed by GitNexus as **Clypt-Frontend** (1239 symbols, 2372 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
