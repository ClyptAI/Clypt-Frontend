...
This project is indexed by GitNexus as **Clypt-Frontend** (1220 symbols, 2341 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
