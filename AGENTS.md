...
This project is indexed by GitNexus as **Clypt-Frontend** (1230 symbols, 2352 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
